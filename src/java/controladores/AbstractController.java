...
public abstract class AbstractController<T> implements Serializable {
    ...
    public void save(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/etiquetas").getString(itemClass.getSimpleName() + "Updated");
    ...
    public void saveNew(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/etiquetas").getString(itemClass.getSimpleName() + "Created");
    ...
    public void delete(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/etiquetas").getString(itemClass.getSimpleName() + "Deleted");
    ...
    private void persist(PersistAction persistAction, String successMessage) {
        if (selected != null) {
            ...
            try {
                ...
                JsfUtil.addErrorMessage(ex, ResourceBundle.getBundle("/etiquetas").getString("PersistenceErrorOccured"));
            }
        }
    }
