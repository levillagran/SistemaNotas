...
import negocio.AsignaturasFacade;
...
@FacesConverter(value = "asignaturasConverter")
public class AsignaturasConverter implements Converter {

    @Inject
    private AsignaturasFacade ejbFacade;
