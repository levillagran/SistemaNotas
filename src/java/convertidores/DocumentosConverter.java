...
import negocio.DocumentosFacade;
...
@FacesConverter(value = "documentosConverter")
public class DocumentosConverter implements Converter {

    @Inject
    private DocumentosFacade ejbFacade;
